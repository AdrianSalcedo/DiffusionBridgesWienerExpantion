...
abline(0,1)
qqplot(Chau_OU_01[,obs],Chaos_OU_01[,obs],ylab="Lyons and Zheng's approach",xlab="Wiener Chaos approach")
abline(0,1)
qqplot(Chau_OU_02[,obs],Chaos_OU_02[,obs],ylab="Lyons and Zheng's approach",xlab="Wiener Chaos approach")
abline(0,1)
qqplot(Chau_OU_0.80.5[,obs],Chaos_OU_0.80.5[,obs],ylab="Lyons and Zheng's approach",xlab="Wiener Chaos approach")
abline(0,1)
